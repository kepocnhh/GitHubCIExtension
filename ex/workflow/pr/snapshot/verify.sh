...
/bin/bash ex/project/verify/common.sh "$JSON_PATH/verify.json" \
 && /bin/bash ex/project/verify/common.sh "$JSON_PATH/verify/documentation.json" \
...
if test $CODE -ne 0; then
 ...
 /bin/bash ex/project/diagnostics/common.sh "$JSON_PATH/verify.json" \
  && /bin/bash ex/project/diagnostics/common.sh "$JSON_PATH/verify/documentation.json" \
 ...
 /bin/bash ex/workflow/pr/snapshot/verify/on_failed.sh \
